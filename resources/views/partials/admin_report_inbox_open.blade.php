<section id="open_reports"> 
        ...
        @foreach ($data["content"] as $report)
            ...
            <div class="card-header " id="heading{{$report['report_id']}}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @else
                        <a href="/posts/{{$report['item']['id']}}"><h5 class="text-primary"><span class="font-weight-bold">Comment:</span> {{$report['item']['body']}} </h5> </a>
                    @endif
                ...
                <div class="card-body ">
                    ...
                    <div class="d-flex my-2 align-items-center justify-content-between">
                        ...
                        <div id="report_inbox_report_tags" class="d-flex align-items-center">
                            ...
                            @if (array_key_exists('tags', $report['item']) )
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" data-report_id="{{$report['report_id']}}" class="close-report btn btn-primary  px-2 mx-3 mt-2">Mark as closed</button>
                    </div>
                </div>
            </div>
        @endforeach
    ...
    <nav class="my-4 report_inbox_open_nav" aria-label="Posts navigation .inbox_open">
        @if (isset($paginator))
